...
struct qt_meta_stringdata_SpeedController_t {
    QByteArrayData data[5];
    char stringdata0[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SpeedController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SpeedController_t qt_meta_stringdata_SpeedController = {
    {
QT_MOC_LITERAL(0, 0, 15), // "SpeedController"
QT_MOC_LITERAL(1, 16, 12), // "speedChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 11), // "updateSpeed"
QT_MOC_LITERAL(4, 42, 5) // "speed"

    },
    "SpeedController\0speedChanged\0\0updateSpeed\0"
    "speed"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SpeedController[] = {
...
void SpeedController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SpeedController::speedChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SpeedController::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SpeedController.data,
    qt_meta_data_SpeedController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SpeedController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpeedController.stringdata0))
